...
//Creating Utility class to display any Toast Message
...
public class Utility {
    ...
    //returns a collection reference for when we want to save a note
    ...
    static CollectionReference getCollectionReferenceForFoods(){
        FirebaseUser currentUser = FirebaseAuth.getInstance().getCurrentUser();
